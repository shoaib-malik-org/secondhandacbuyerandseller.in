            ...
            >
              <div className="position-relative z-10 ms-lg mt-lg col-md-6">
                <h1 className="text-white display-3 fw-bold heading text-center text-md-start">
                  Second hand ac sale & purchase
                </h1>
                <p className="h4 text-lgrey fw-normal paragraph mt-4 text-center text-md-start">
                ...
                <Link href={`tel:+${phoneNumber}`}>
                  <button className="btn btn-theme rounded-pill p-2 px-4 mt-4 text-large ms-md-0 ms-auto me-auto d-block">
